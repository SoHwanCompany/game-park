...
const EXP_SCORE_MULTIPLIER = 0.1;
const EXP_PLAYTIME_MULTIPLIER = 2;
const MIN_EXP_PER_GAME = 1;

export const calculateExp = (score: number, playtimeSeconds: number): number => {
  const scoreExp = Math.floor(score * EXP_SCORE_MULTIPLIER);
